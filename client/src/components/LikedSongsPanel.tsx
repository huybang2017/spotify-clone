    ...
    <aside className="w-[420px] flex flex-col bg-neutral-950 rounded-lg p-4 ml-2 h-full">
      ...
      <div className="flex flex-col items-center mb-6">
        ...
        <div className="text-center">
          <div className="uppercase text-xs text-neutral-400 font-semibold">
            Playlist
          </div>
      ...
      <div className="bg-neutral-900 rounded-lg p-4 mb-6 flex flex-col items-center">
        <img
          ...
          className="w-24 h-24 rounded mb-3 object-cover"
        />
        <div className="text-white font-bold text-base mb-1 text-center">
          ...
          <button className="hover:text-white cursor-pointer">
            ...
            >
              <path
                ...
                d="M17.25 6.75v10.5m-5.25-5.25h10.5"
              />
            </svg>
          </button>
        </div>
      ...
      <div className="bg-neutral-900 rounded-lg p-4 flex flex-col items-center">
        <div className="w-full text-xs text-neutral-400 mb-2">
          About the artist
        </div>
        <img
          src="https://i.scdn.co/image/ab6761610000e5eb1d6e1de9f4c4d5b4d7f5b1d6"
          alt="Sơn Tùng M-TP"
          className="w-24 h-24 rounded-full mb-2 object-cover"
        />
        <div className="text-white font-bold text-base mb-1">Sơn Tùng M-TP</div>
        <div className="text-xs text-neutral-400 text-center">
          Vietnamese singer, songwriter, and actor. One of the most successful
          V-pop artists.
        </div>
      </div>
    </aside>
